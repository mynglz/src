...
namespace Incyte.Services
{
    public class BusinessService : IBusinessService
    {
        ...
        public List<Entities.Business> BusinessGet(Entities.Location location)
        {
            try
            {
                List<Entities.Business> businesses = new List<Business>();

                List<Entities.Business> bss = businessResource.BusinessGetByLocation(
                    location.Latitude,location.Longitude,location.Radius, this.BusinessConverter, businesses) as List<Entities.Business>;
        ...
        private object BusinessConverter(IDataReader dr, object dataObject)
        {
            ...
            //string[] keys = { "BusinessId", "CheckinCount", "IsSponsored" };

            if (businesses == null)
                businesses = new List<Entities.Business>();
            ...
            business.Name = dr["BusinessName"].ToString();
            ...
            //                    break;
            //                case "IsSponsored":
            //                    business.IsSponsored = short.Parse(dr[key].ToString());
            //                    break;
            //                default:
            //                    break;
            //            }
            ...
            //business.IsSponsored = short.Parse(dr["IsSponsored"].ToString()); 
